...
function Datepick() {
	...
	this.regional[''] = { // Default regional settings
		...
		prevStatus: 'Mostrar el mes anterior', // Status text for previous month link
		prevBigText: '&#x3c;&#x3c;', // Display text for previous year link
		prevBigStatus: 'Mostrar el año anterior', // Status text for previous year link
		nextText: 'Siguiente&#x3e;', // Display text for next month link
		nextStatus: 'Mostrar el siguiente mes', // Status text for next month link
		nextBigText: '&#x3e;&#x3e;', // Display text for next year link
		nextBigStatus: 'Mostrar el año siguiente', // Status text for next year link
		currentText: 'Hoy', // Display text for current month link
		currentStatus: 'Mostrar el mes actual', // Status text for current month link
		...
		monthStatus: 'Mostrar un mes distinto', // Status text for selecting a month
		yearStatus: 'Mostrar un año distinto', // Status text for selecting a year
		...
		dayStatus: 'Setear DD como primer día de la semana', // Status text for the day of the week selection
		dateStatus: 'Seleccione DD, M d', // Status text for the date selection
		dateFormat: 'mm/dd/yy', // See format options on parseDate
		firstDay: 0, // The first day of the week, Sun = 0, Mon = 1, ...
		initStatus: 'Seleccione una fecha', // Initial Status text on opening
